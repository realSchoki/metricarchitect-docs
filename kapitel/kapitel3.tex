...
As mentioned earlier a sensor can be anything and is a physical device which measures all kinds of metrics. \cref{fig:abstract_sensor} shows a simple model of sensors. A sensor can have any number metrics but at least one.
